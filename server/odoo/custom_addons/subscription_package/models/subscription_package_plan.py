...
class SubscriptionPackagePlan(models.Model):
    ...
    product_line_ids = fields.One2many(
        'subscription.package.plan.line',
        'plan_id',
    ...
    product_line_ids = fields.One2many(
        'subscription.package.product.line',  # You can also make a dedicated template model if needed
        'plan_id',
        string='Default Products',
        help='Default products included in this subscription plan'
    )
...
class SubscriptionPackagePlanLine(models.Model):
    _name = 'subscription.package.plan.line'
    _description = 'Subscription Package Plan Line'
    ...
    def _onchange_plan_id(self):
        if self.plan_id:
            ...
            for line in self.plan_id.product_line_ids:
                self.product_line_ids = [(0, 0, {
                    'product_id': line.product_id.id,
                    'product_qty': line.product_qty,
                    'unit_price': line.unit_price or line.product_id.list_price,
